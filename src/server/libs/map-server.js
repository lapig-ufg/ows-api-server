...
module.exports = function (app) {
	...
	Internal.printf = function (str, params) {
		for (var i in params) {
	...
	Internal.getSldParam = function (params) {
		...
		var sldUrl = Internal.printf("{0}/sld/{1}", [hostname, layers]);
	...
	Mapserver.run = function (params, onDataFn, onCloseFn) {
		...
		cmdParams = Internal.printf(cmdParams, [config['path_mapfile'], queryParams, sldParam]);
